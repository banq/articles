package com.doublexman.xxbpm;

import com.doublexman.xxbpm.config.ApplicationProperties;
import com.doublexman.xxbpm.config.DefaultProfileUtil;
...
@ComponentScan(basePackages = {"com.doublexman.xxbpm"})
